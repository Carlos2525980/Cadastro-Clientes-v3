    ...
    public partial class FrmCadastro : Form
    {
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    conexao = new SqlConnection(@"Data Source = CARLOSALEXANDRE; Initial Catalog = CADASTRO_CLIENTES; Persist Security Info = True; User ID = sa;Password=123456;TrustServerCertificate=True");
                    ...
                    comando.Parameters.AddWithValue("@NOME", cli.Name = Convert.ToString(txtNome.Text));
                    comando.Parameters.AddWithValue("@ENDERECO", cli.Endereco = Convert.ToString(txtEndereco.Text));
                    comando.Parameters.AddWithValue("@BAIRRO", cli.Bairro = Convert.ToString(txtBairro.Text));
                    comando.Parameters.AddWithValue("@COMPLEMENTO", cli.Complemento = Convert.ToString(txtComplemento.Text));
                    comando.Parameters.AddWithValue("@CIDADE", cli.Cidade = Convert.ToString(txtCidade.Text));
                    comando.Parameters.AddWithValue("@EMAIL", cli.Email = Convert.ToString(txtEmail.Text));
                    comando.Parameters.AddWithValue("@TELEFONE", cli.Telefone = Convert.ToString(txtTelefone.Text));
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                comando.Parameters.AddWithValue("@NOME", cli.Name = Convert.ToString(txtPesquisar.Text));
